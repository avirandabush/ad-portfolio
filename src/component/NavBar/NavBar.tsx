  ...
  return (
    <div className={`nav-bar-view ${language === 'he' ? 'rtl' : ''}`}>
      ...
      <ul className="nav-left">
        ...
        <li>
          <button
            className={currentPage === Page.IOS ? 'is-on' : ''}
            onClick={() => setPage(Page.IOS)}
          >
            {t('ios_button')}
          </button>
        </li>
        <li>
          <button
            className={currentPage === Page.Android ? 'is-on' : ''}
            onClick={() => setPage(Page.Android)}
          >
            {t('android_button')}
          </button>
        </li>
        <li>
          <button
            className={currentPage === Page.ReactJS ? 'is-on' : ''}
            onClick={() => setPage(Page.ReactJS)}
          >
            {t('reactJS_button')}
          </button>
        </li>
        <li>
          <button
            className={currentPage === Page.Details ? 'is-on' : ''}
      ...
      <ul className="nav-right">
        <li>
          <button onClick={() => setLanguage('en')}>
            <img className="nav-bar-logo lang-img" src={usa} />
          </button>
        </li>
        <li>
          <button onClick={() => setLanguage('fr')}>
            <img className="nav-bar-logo lang-img" src={france} />
          </button>
        </li>
        <li>
          <button onClick={() => setLanguage('he')}>
            <img className="nav-bar-logo lang-img" src={israel} />
          </button>
        </li>
      </ul>
    </div>
